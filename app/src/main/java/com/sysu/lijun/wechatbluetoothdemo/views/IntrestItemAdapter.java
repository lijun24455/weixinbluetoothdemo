...
/**
 * 我的关注ListView的Adapter
 * Created by lijun on 15/7/13.
 */
public class IntrestItemAdapter extends BaseAdapter {

    private Context context;
    private List<IntrestDetail> list;

    public IntrestItemAdapter(Context context, List<IntrestDetail> mProductList) {
